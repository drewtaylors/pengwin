...
bot.py - Drew Taylor - 4.26.18

Main module control for Pengwin Slack chatbot.
Acts as the server for all Pengwin's needs.
...
if __name__ == '__main__':
    if slack_client.rtm_connect(with_team_state=False):
        print('Pengwin is connected and running!')
